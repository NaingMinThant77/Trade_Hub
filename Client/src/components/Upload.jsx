...
const Upload = ({ editProductId, setActiceTabKey }) => {
    ...
    return (
        <section>
            <h1 className='text-2xl font-bold mb-4'>Upload your Product's Images Here.</h1>
            <form method='post' encType='multipart/form-data' onSubmit={submitHandler}>
                ...
                <button className='block my-4 text-white bg-blue-600 rounded-md px-3 py-2 font-medium'>Upload to product</button>
            </form>
        </section>
    )
}
