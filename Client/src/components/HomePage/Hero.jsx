...
const Hero = ({ setProducts, getProducts }) => {
    ...
    return (
        <div className="w-full text-center mb-2 mt-10">
            <h1 className="text-3xl font-bold text-blue-600 mb-4">"Discover, Connect and Thrive with TradeHub"</h1>
            ...
            <div className="max-w-sm mx-auto flex items-center gap-2">
                <div className="relative w-full">
                    <input type="text" className="bg-gray-100 outline-none p-2 rounded-xl w-full" value={searchKey} onChange={e => setSearchKey(e.target.value)} />
